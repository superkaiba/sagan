...
const ISSUE_DEFAULTS_BY_STAGE: Record<PipelineStageKey, { status: string; priority: 'low' | 'normal' | 'high' | 'urgent' }> = {
  ...
  clarifying: { status: 'clarifying', priority: 'normal' },
...
const dropTargets: Record<PipelineCardKind, PipelineStageKey[]> = {
  experiment: ['later', 'idea', 'clarifying', 'planning', 'approval', 'running', 'interpreting', 'followups_running', 'blocked', 'review', 'done', 'archived'],
