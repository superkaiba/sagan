...
// Renders the plan markdown as commentable text, mirroring the /p/[slug]
// reading UX. The anchored-comment popover and Comments thread come from the
// page-level AnchoredCommentsProvider + sidebar Comments component, so this
// component just owns the plan body and the Revise button. Anchored comments
// the owner posts here are scoped to entityKind='experiment' (the page-level
// scope); the Revise button re-dispatches the planner with every unresolved
// comment so Claude can address them in one shot.
